...
/// </summary>
/// <remarks>
/// Had to add a SuppressionMessage of Android API 21 (Android 5.0) warning. Minimum
/// Android version is 14.0 (API 34).
/// </remarks>
[SuppressMessage("Interoperability", "CA1416:Validate platform compatibility")]
public sealed class DataGridColumn : Element, IDefinition
{
    ...
    public static readonly BindableProperty WidthProperty =
        BindablePropertyExtension.Create<DataGridColumn, GridLength>(
    ...
    public static readonly BindableProperty TitleProperty =
        BindablePropertyExtension.Create<DataGridColumn, string>(
    ...
    public static readonly BindableProperty FormattedTitleProperty =
        BindablePropertyExtension.Create<DataGridColumn, FormattedString>(
    ...
    public static readonly BindableProperty IsVisibleProperty =
        BindablePropertyExtension.Create<DataGridColumn, bool>(
            defaultValue: true,
            propertyChanged: (b, _, _) =>
            {
    ...
    public static readonly BindableProperty CellTemplateProperty =
        BindablePropertyExtension.Create<DataGridColumn, DataTemplate>();
    ...
    public static readonly BindableProperty LineBreakModeProperty =
        BindablePropertyExtension.Create<DataGridColumn, LineBreakMode>(LineBreakMode.WordWrap);

    /// <summary>
    /// Gets or sets the horizontal content alignment for the column.
    /// </summary>
    public static readonly BindableProperty HorizontalContentAlignmentProperty =
        BindablePropertyExtension.Create<DataGridColumn, LayoutOptions>(LayoutOptions.Center);
    ...
    public static readonly BindableProperty PaddingProperty =
        BindablePropertyExtension.Create<DataGridColumn, Thickness>(Thickness.Zero);
    ...
    public static readonly BindableProperty HeaderLabelStyleProperty =
        BindablePropertyExtension.Create<DataGridColumn, Style>(
            propertyChanged: (b, _, n) =>
            {
                if (b is DataGridColumn self && self.HeaderLabel != null)
                {
                    if (n is null)
                    {
                        ...
                        {
                            self.HeaderLabel.Style = DataGrid.DefaultHeaderLabelStyle;
                        }
                    }
                    else
                    {
            ...
            propertyChanged: (b, _, n) =>
            {
                if (b is DataGridColumn self)
                {
                    if (n is null)
                    {
                        if (self.DataGrid is not null)
                        {
                            self.FilterTextbox.Style = DataGrid.DefaultHeaderFilterStyle;
                        }
                    }
                    else
                    {
    ...
    /// <summary>
    /// Gets or sets text displayed in the Filter entry.
    /// </summary>
    ...
    internal Label HeaderLabel { get; } = new Label();

    internal Grid HeaderLabelContainer { get; } = new Grid
    {
        ColumnDefinitions =
        [
