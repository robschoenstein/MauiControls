...
internal sealed class DataGridHeaderRow : Grid
{
    ...
    public static readonly BindableProperty DataGridProperty =
        BindablePropertyExtension.Create<DataGridHeaderRow, DataGrid>(null, BindingMode.OneTime);
    ...
    protected override void OnParentSet()
    {
        ...
        else
        {
            ...
            SetBinding(BackgroundColorProperty,
                BindingBase.Create<DataGrid, Color>(static x =>
                    x.BorderColor, source: DataGrid));
        }
    }
    ...
    private static void OnSort(DataGridColumn column)
    {
        ...
        var order = column.SortDirection == SortDirection.Ascending
    ...
    private DataGridCell CreateHeaderCell(DataGridColumn column)
    {
        ...
        column.HeaderLabel.Style =
            column.HeaderLabelStyle ?? DataGrid.HeaderLabelStyle ?? DataGrid.DefaultHeaderLabelStyle;
        column.FilterTextbox.Style =
            column.HeaderFilterStyle ?? DataGrid.HeaderFilterStyle ?? DataGrid.DefaultHeaderFilterStyle;
