...
internal sealed class DataGridRow : Grid
{
    ...
    public static readonly BindableProperty DataGridProperty =
        BindablePropertyExtension.Create<DataGridRow, DataGrid>(
            null,
            BindingMode.OneTime,
    ...
    public static readonly BindableProperty RowToEditProperty =
        BindablePropertyExtension.Create<DataGridRow, object>(
            null,
            BindingMode.OneWay,
    ...
    public static readonly BindableProperty CellBackgroundColorProperty =
        BindablePropertyExtension.Create<DataGridRow, Color>(
